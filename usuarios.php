...
<html lang="es">
	...
	<body>
				...
				<div class="col-md-3">
					<div class="panel panel-default" >
						<div class="panel-heading">
							<button class="btn btn-default" type="button" onclick="cargarLista()"><span class="glyphicon glyphicon-refresh"></span></button> Lista de usuarios
						</div>
		...
		<script type="text/javascript">
			// Url del controlador
			var control = 'usuario_controller.php';
				...
				$.getJSON(control, 
					...
					function(json){
						if ( json.resultado ) {
							...
							$('#usuario').val(json.item.usuario);
							$('#contrasena').val(json.item.contrasena);
							$('#nombre').focus();
