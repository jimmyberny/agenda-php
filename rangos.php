...
<html lang="es">
    ...
    <body>
                ...
                <div class="col-md-3">
                    <div class="panel panel-default" >
                        <div class="panel-heading">
                            <button class="btn btn-default" type="button" onclick="cargarLista()"><span class="glyphicon glyphicon-refresh"></span></button> Lista de rangos
                        </div>
        ...
        <script type="text/javascript">
            // Url del controlador
            var control = 'rango_controller.php';
                ...
                if (gblAccion == 'eliminar') {
                    $.post(control,
                        ...
                        function(json) {
                            if (json.resultado) {
                                cargarLista();
                                uxSuccessAlert('Rango eliminado correctamente');
                            } else {
                                uxErrorAlert('No se pudo eliminar el rango. ' + json.error );
                            }
                        });
                    ...
                    $.post(control, 
                        ...
                        function(json) {
                            if ( json.resultado ) {
                                clearForm();
                                cargarLista();
                                uxSuccessAlert('El rango se ha guardado correctamente');
                            } else {
                                // Mostrar error
                                uxErrorAlert('No se pudo guardar el rango');
                            }
                        });
                }
            }
                ...
                $.getJSON(control, 
                    ...
                    function(json){
                        if ( json.resultado ) {
                            ...
                            selId = null;
                            uxErrorAlert('No se encontró el rango.');
                        }
                    });
            }
