...
<html lang="es">
    ...
    <body>
                ...
                <div class="col-md-3">
                    <div class="panel panel-default" >
                        <div class="panel-heading">
                            <button class="btn btn-default" type="button" onclick="cargarLista()"><span class="glyphicon glyphicon-refresh"></span></button> Lista de giros
                        </div>
        ...
        <script type="text/javascript">
            // Url del controlador
            var control = 'giro_controller.php';
                ...
                if (gblAccion == 'eliminar') {
                    $.post(control,
                        ...
                        function(json) {
                            if (json.resultado) {
                                cargarLista();
                                uxSuccessAlert('Giro eliminado correctamente');
                            } else {
                                uxErrorAlert('No se pudo eliminar el giro. ' + json.error );
                            }
                        });
                    ...
                    $.post(control, 
                        ...
                        function(json) {
                            if ( json.resultado ) {
                                clearForm();
                                cargarLista();
                                uxSuccessAlert('El giro se ha guardado correctamente');
                            } else {
                                // Mostrar error
                                uxErrorAlert('No se pudo guardar el giro');
                            }
                        });
                }
            }
